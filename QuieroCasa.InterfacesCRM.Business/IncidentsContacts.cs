    ...
    public class IncidentsContacts : IIncidentsContacts
    {
            ...
            , bool? sala, bool? comedor, bool? cocina, bool? patioServicio, bool? bano, bool? recamara, bool? cajonEstacionamiento, bool? bodega, bool? areasComunes, bool? otro, string especificar)
        {
            ...
            try
            {
                ...
                string desarrolloKey = desarrollo.Substring(0, 3);
                ...
                {
                    case 1: // Ventas
                        area = "112D12F5-7ACC-E611-8122-0050568A0735";
                break;
                    case 2: // Post-venta
                        area = "5363FDFB-7ACC-E611-8122-0050568A0735";
                    ...
                    case 3: // Atención a Clientes
                        area = "87B04607-7BCC-E611-8122-0050568A0735";
                        ...
                        break;
                    case 4: // Otro
                        area = "49B7060E-7BCC-E611-8122-0050568A0735";
                        break;
                }
                ...
                response.caseId = incidents.Add(organization, contactId, nombres + " " + apPaterno + " " + apMaterno, correo, its_personaidentificada, area, telefono, response.ListContacts.Count, paqueteId, desa.qc_desarrollosid, qc_personaidentificadaporvivienda, qc_personaidentificadaportelefono, postVentaId, comentarios
                    ,sala, comedor, cocina, patioServicio, bano, recamara, cajonEstacionamiento, bodega, areasComunes, otro, especificar);
            ...
            {
                LogErroresManagement.Add(organization, ex.Message, nombres + " " + apPaterno + " " + apMaterno, correo, telefono, area, paqueteId, desa.qc_desarrollosid);
